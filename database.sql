...
nom_utilisateur_client_avis VARCHAR(50),
...
PRIMARY KEY (id_transaction, id_livraison),
FOREIGN KEY (id_transaction) REFERENCES Transactions(id_transaction),
FOREIGN KEY (id_livraison) REFERENCES Livraisons(id_livraison)
);
...
VALUES ("durand_mehdy17", "durand_mehdy17");
...
VALUES (4, 10, 10); -- ail
INSERT INTO Composition_Plats (id_plat, id_ingredient, quantite)
VALUES (4, 11, 300); -- gambas
INSERT INTO Composition_Plats (id_plat, id_ingredient, quantite)
VALUES (4, 1, 150); -- tomate
INSERT INTO Composition_Plats (id_plat, id_ingredient, quantite)
VALUES (4, 5, 50); -- oignon
INSERT INTO Composition_Plats (id_plat, id_ingredient, quantite)
VALUES (4, 12, 450); -- poulet
...
VALUES (1, "2025-02-26 19:14:07", "durand_mehdy17");
...
VALUES (1, "2025-02-26 19:15:55", FALSE, "Cardinet");
INSERT INTO Transac_Engendre_Livraison (id_transaction, id_livraison)
VALUES (1, 1);
...
INSERT INTO Transactions (id_transaction, date_transaction, nom_utilisateur_client)
VALUES (2, "2025-02-27 17:38:43", "leclerc_marine89");
...
INSERT INTO Livraisons (id_livraison, date_livraison, terminee, station_metro)
VALUES (2, "2025-02-27 17:45:03", FALSE, "Republique");
INSERT INTO Transac_Engendre_Livraison (id_transaction, id_livraison)
VALUES (2, 2);
...
INSERT INTO Livraisons (id_livraison, date_livraison, terminee, station_metro)
VALUES (3, "2025-02-27 17:48:15", FALSE, "Franklin D. Roosevelt");
INSERT INTO Transac_Engendre_Livraison (id_transaction, id_livraison)
VALUES (2, 3);
...
-- Selectionner les utilisateurs qui sont a la fois cuisiniers et clients
SELECT DISTINCT nom_utilisateur_cuisinier
FROM Cuisiniers
WHERE nom_utilisateur_cuisinier IN (
SELECT nom_utilisateur_client
FROM Clients
);

-- Selection des plats qui sont en cours de livraison
SELECT * FROM Plats
WHERE id_livraison IN (
SELECT id_livraison
FROM Livraisons
);